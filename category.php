...
<style id="dg-category-styles">
    ...
    /* FORCES the sticky sidebar to work by overriding global theme rules */
    html, body {
    ...
    @media (min-width: 768px) { .cat-layout-container { padding: 10rem 2rem 8rem; } }

    .cat-grid {
        display: grid; grid-template-columns: 1fr; gap: 2rem; align-items: start;
    }
    @media (min-width: 1024px) {
        .cat-grid { grid-template-columns: 1fr 340px; gap: 4rem; }
    }

    .cat-main-col { min-width: 0; display: flex; flex-direction: column; gap: 2rem; }
    @media (min-width: 768px) { .cat-main-col { gap: 2.5rem; } }
    ...
    /* ==========================================================================
       CATEGORY HEADER
       ========================================================================== */
    .cat-header { margin-bottom: 0.5rem; }
    .cat-eyebrow {
    ...
    .cat-title span { color: var(--color-primary); }
    .cat-desc { color: var(--color-muted); font-size: clamp(0.95rem, 3vw, 1.1rem); line-height: 1.6; max-width: 800px; }

    /* ==========================================================================
       CATEGORY CARDS (Text Only & Mobile Optimised)
       ========================================================================== */
    .cat-card {
    ...
    @media (min-width: 640px) {
        .cat-card-meta { flex-direction: row; align-items: center; font-size: 0.75rem; margin-bottom: 1.25rem; }
    }
    .cat-card-meta i { color: var(--color-primary); width: 14px; text-align: center; }
    ...
    @media (min-width: 768px) {
        .cat-card h2 { margin-bottom: 1rem; line-height: 1.4; }
    }
    .cat-card:hover h2 { color: var(--color-primary); }
    
    .cat-card p { 
        font-size: 0.95rem; color: var(--color-muted); line-height: 1.6; margin-bottom: 1.5rem; 
    }
    @media (min-width: 768px) {
        .cat-card p { font-size: 1.05rem; line-height: 1.7; margin-bottom: 2rem; }
    }
    ...
    @media (min-width: 768px) {
        .cat-card-btn { font-size: 0.85rem; }
    }
    .cat-card-btn i { color: var(--color-primary); transition: transform 0.3s ease; }
    .cat-card:hover .cat-card-btn { color: var(--color-primary); }
    .cat-card:hover .cat-card-btn i { transform: translateX(5px); }
    ...
    @media (min-width: 768px) {
        .cat-pagination { margin-top: 3rem; }
    }
    .cat-pagination a {
    ...
    @media (min-width: 768px) {
        .cat-pagination a { font-size: 0.85rem; padding: 0.75rem 1.5rem; }
    }
    .cat-pagination a:hover { background: rgba(47,228,59,0.1); border-color: var(--color-primary); color: var(--color-primary); }
</style>

<main class="cat-wrapper">
    ...
    <div class="cat-layout-container">
        <div class="cat-grid">
            ...
            <div class="cat-main-col">
                ...
                <header class="cat-header animate-fade" style="animation-delay: 0.1s;">
                    <div class="cat-eyebrow">
                        <div class="cat-status-dot"></div> Topic Directory
                    </div>
                    <h2 class="cat-title">
                        <?php single_cat_title( 'Topic: <span>', true ); ?></span>
                    </h2>
                ...
                <?php if ( have_posts() ) : ?>
                    ...
                    ?>
                        <a href="<?php the_permalink(); ?>" class="cat-card animate-fade" style="animation-delay: <?php echo $delay; ?>s;">
                            ...
                            <div class="cat-card-btn">Read Article <i class="fa-solid fa-arrow-right"></i></div>
                        </a>
                    <?php 
                    $delay += 0.1;
                    endwhile; 
                    ...
                    <!-- Pagination -->
                    <div class="cat-pagination animate-fade" style="animation-delay: <?php echo $delay; ?>s;">
                ...
                <?php else : ?>
                    ...
                    <div class="cat-card animate-fade" style="animation-delay: 0.2s; padding: 4rem 2rem; text-align: center; display: block;">
            ...
            <aside class="cat-sidebar-col animate-fade" style="animation-delay: 0.2s;">
                <?php get_sidebar(); ?>
            </aside>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var sidebar = document.querySelector('.cat-sidebar-col');
        if (sidebar) {
